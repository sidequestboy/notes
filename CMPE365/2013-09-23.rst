...
In each term of the sum of products, one of the factors must have a value of True.
...
Suppose :math:`E` is satisfiable. Then each clause has a True literal flag, and the vertices corresponding to those vertices **must** form a k-clique in the graph.
