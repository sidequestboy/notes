...
.. admonition:: Definition
	...
	We say sa state :math:`i` is "recurrent" if :math:`f_i=1`
...
.. admonition:: Corollary 2
	...
	Proof:
	------
	state :math:`i` communicates with state :math:`j` :math:`\implies` that there exists :math:`m,n` so that :math:`p_{i,j}(n)>0` & :math:`p_{j,i}(n)>0`
	...
	.. math::
		...
		\implies state :math:`j` is recurrent
